...
dlmodel = load_model(r'/Users/zhangkunyi/PythonCode/Doctor Research 4Q/ABM/DLGModel.h5', compile=False)
...
class BusinessModel(mesa.Model):
    ...
    def process_agent(self, i, type_prob):
        ...
        self.all_agents_history.loc[len(self.all_agents_history.index)] = [i, ori_x, ori_y, ori_poi_x, ori_poi_y,
                                                                           a_type, random_time]
        ori_x_init, ori_y_init, ori_poi_x_init, ori_poi_y_init = ori_x, ori_y, ori_poi_x, ori_poi_y
        ...
        for j in range(1, trip_times + 1):
            ...
            if a_pattern[j % len(a_pattern)] == a_pattern[0]:  # Assuming a_pattern is a string
                x, y, poi_x, poi_y = ori_x_init, ori_y_init, ori_poi_x_init, ori_poi_y_init
            else:
